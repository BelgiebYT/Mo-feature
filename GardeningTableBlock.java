...
public class GardeningTableBlock extends Block implements ISidedInventoryProvider {
        ...
        protected static final VoxelShape TOP_SHAPE = Block.makeCuboidShape(0.0D, 9.0D, 0.0D, 16.0D, 16.0D, 16.0D);
    ...
    public static void init() {
            ...
            registerCompostable(1.0F, BlockInit.MAGENTA_LEAVES.get().asItem());
   ...
   public GardeningTableBlock(AbstractBlock.Properties properties) {
            super(properties);
    ...
    public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        ...
        public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult
        hit) {
        ...
        public ISidedInventory createInventory(BlockState state, IWorld world, BlockPos pos) {
            int i = state.get(LEVEL);
            if (i == 8) {
                return new GardeningTableBlock.FullInventory(state, world, pos, new ItemStack(ItemInit.BETTER_BONE_MEAL.get()));
            } else {
                return (ISidedInventory)(i < 7 ? new GardeningTableBlock.PartialInventory(state, world, pos) : new GardeningTableBlock.EmptyInventory());
            }
        }
        ...
        static class FullInventory extends Inventory implements ISidedInventory {
            ...
            public void markDirty() {
                GardeningTableBlock.resetFillState(this.state, this.world, this.pos);
                this.extracted = true;
            }
        }
        ...
        static class PartialInventory extends Inventory implements ISidedInventory {
            ...
            public void markDirty() {
                ...
                if (!itemstack.isEmpty()) {
                    this.inserted = true;
                    BlockState blockstate = GardeningTableBlock.attemptCompost(this.state, this.world, this.pos, itemstack);
